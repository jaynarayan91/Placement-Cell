            ...
            <div className="row">
                ...
                <div className="col-three tab-full footer-social">
                    ...
                    <ul className="list-links">
                        ...
                        <li>
                            <a href="https://twitter.com/CUTMIndia">Twitter</a>
                        </li>
                ...
                <div className="col-four tab-full footer-subscribe end">
                   ...
                   {/* <!-- <p>Leave your Email and we'll get back to you asap !</p> --> */}

                   <ul className="list-links">
                    <a className="" 
                    href="./docs/Placement Brochure IIIT Trichy.pdf" target="_blank" title="View Our Brochure" >
                    ...
                    <li>
                        <a href="http://www.iiitt.ac.in/" target="_blank">CUTM Paralakhemundi</a>
                    </li>
